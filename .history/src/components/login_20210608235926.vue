    ...
    <div class="login_box">
      ...
      <el-form :model="loginform" :rules="rules" ref="loginFormRef" label-width="0px" class="login_form">
        ...
        <el-form-item prop="username">
          <el-input v-model="loginform.username" prefix-icon="el-icon-user" v-model="loginform.username"></el-input>
        </el-form-item>
        <!-- 密码 -->
        <el-form-item prop="password">
          <el-input v-model="loginform.password" prefix-icon="el-icon-lock" show-password v-model="loginform.password"></el-input>
        </el-form-item>
        <!-- 按钮区域 -->
