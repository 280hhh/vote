...
export default {
  data(){
    return{
        ...
        {src:require('../image/霸王别姬.jpg'),name:'霸王别姬',class:'爱情/剧情/同性',number:'6',votes:'1',value:'霸王别姬',ds:"'希望让人自由'"},
        {src:require('../image/这个杀手不太冷.jpg'),name:'这个杀手不太冷',class:'犯罪/剧情/动作',number:'7',votes:'1',value:'这个杀手不太冷',ds:"'希望让人自由'"},
