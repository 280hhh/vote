<template>
  <div class="result_container">
    <div class="result_box">
      <el-table :data="contestants" stripe style="width:40%;margin:auto;">
            ...
            <template slot-scope="scope">
            <el-progress :show-text="false" :stroke-width="18" :percentage="(scope.row.votes/15)" :color="colors" v-if="!isNaN(scope.row.votes/15)">
                </el-progress>
            </template>
            </el-table-column >
